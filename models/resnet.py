...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print(fea1.shape, fea2.shape, fea3.shape, x.shape)
        ...
        print(out1_feature.shape, out2_feature.shape,
              out3_feature.shape, out4_feature.shape)
...
if __name__ == '__main__':
    x = (3, 64, 64)
    model = resnet50()
    summary(model, input_size=x, device='cpu')
