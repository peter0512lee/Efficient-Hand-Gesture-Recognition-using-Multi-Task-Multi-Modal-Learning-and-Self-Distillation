...
from models.models_SD import TSN
...
def main():
    ...
    if args.dataset == 'EgoGesture':
        ...
        exp_path = "runs/jester/SD/"
    elif args.dataset == 'NvGesture':
        exp_path = "runs/NvGesture/SD/"

    if args.dataset == 'EgoGesture':
        args.model_name = args.checkpoint_path.split('/')[4] + "_SD"
    else:
        args.model_name = args.checkpoint_path.split('/')[3] + "_SD"
